...
void main() {
	...
	vec3 v = normalize(scene_vertex_position - campos); // unit_vertex_to_cam
	...
	float prod_esc_vertex_perf_reflex = dot(r,v); if (prod_esc_vertex_perf_reflex < 0) prod_esc_vertex_perf_reflex = 0; 
...
void init_scene()
{
	...
	modelo = cargar_modelo((char*) "bin/data/esfera_520_n.bix");
